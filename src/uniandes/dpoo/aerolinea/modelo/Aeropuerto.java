...
public class Aeropuerto
{
    ...
    // Métodos cto, get: nombre, codigo, nombre ciudad, latitud, longitud
    
	public Aeropuerto(String nombre, String codigo, String nombreCiudad, double latitud, double longitud,
			Set<String> codigosUtilizados) throws Exception {
		// Completar con la exception
		this.nombre = nombre;
		this.codigo = codigo;
		this.nombreCiudad = nombreCiudad;
		this.latitud = latitud;
		this.longitud = longitud;
		this.codigosUtilizados = codigosUtilizados; // Revisar si los debo quitar
	}
